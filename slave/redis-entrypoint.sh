...
# start redis
exec docker-entrypoint.sh redis-server /etc/redis/redis.conf --protected-mode no --maxmemory-policy allkeys-lru  --maxmemory 256M  --loglevel verbose  --save  --appendonly no